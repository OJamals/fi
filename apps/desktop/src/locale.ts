...
export const en = {
  ...
  hideApplication: 'Hide fi',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit fi',
  openApplication: 'Open fi',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit fi?',
  ...
  welcomeKeyDescription: 'Configure official DeepSeek models to start using fi',
  ...
  updateDownloadedTitle: 'fi v{version} downloaded',
...
export const zh = {
  ...
  hideApplication: '隐藏 fi',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 fi',
  openApplication: '打开 fi',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 fi？',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'fi v{version} 下载完成',
