...
export const en = {
  ...
  startupFailed: 'fi could not start',
  startupLoading: 'Starting fi…',
...
export const zh = {
  application: '应用',
  startupFailed: 'fi 无法启动',
  startupLoading: '正在启动 fi…',
