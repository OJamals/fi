...
export interface Config {
  /** fi home containing the fixed user-global `AGENTS.md`; defaults to `$DSH_HOME` or `~/.fi`. */
  dshHome?: string
...
export interface Config {
  /** Explicit fi home; omitted follows `DSH_HOME`, then `~/.fi`. */
  dshHome?: string
...
export interface Config {
  /** fi home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.fi`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** fi config root. Defaults to `$DSH_HOME` or `~/.fi`. */
  dshHome?: string
...
<!-- BEGIN GENERATED config-catalog:@fi/llm-antigravity -->
<a id="fillm-antigravity"></a>
...
<!-- BEGIN GENERATED config-catalog:@fi/tool-image-generation -->
<a id="fitool-image-generation"></a>

## `@fi/tool-image-generation`

- `inject`: `tools` · `attachments` · `fs` · `credentials`
- `source`: [`packages/fi/tool-image-generation/src/index.ts:34`](../packages/fi/tool-image-generation/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@fi/tool-image-generation -->

<!-- BEGIN GENERATED config-catalog:@fi/web-search-preferences -->
...
```
<!-- END GENERATED config-catalog:@fi/web-search-preferences -->

<!-- BEGIN GENERATED config-catalog:@fi/web-search-subscription -->
<a id="fiweb-search-subscription"></a>

## `@fi/web-search-subscription`

- `inject`: `web` · `credentials`
- `source`: [`packages/fi/web-search-subscription/src/index.ts:43`](../packages/fi/web-search-subscription/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@fi/web-search-subscription -->
