...
Requires: `tools` · `attachments` · `fs` · `credentials`
...
Depends on: [`PerplexityRecency`](../packages/web/web-search-perplexity/src/index.ts) · [`SubscriptionSearchFamily`](../packages/fi/web-search-subscription/src/index.ts)

Source: [`packages/fi/web-search-preferences/src/types.ts:55`](../packages/fi/web-search-preferences/src/types.ts)

<a id="fiweb-search-subscription"></a>

## `@fi/web-search-subscription`

Requires: `web` · `credentials`
...
- `@fi/llm-antigravity` — requires `authorization` · `credentials` · `llm` · `settings` ([`packages/fi/llm-antigravity/src/index.ts`](../packages/fi/llm-antigravity/src/index.ts))
