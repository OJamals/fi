...
export const zh = {
  ...
  'review.restore': '恢复…',
  'review.restoreAria': '恢复 {name}',
  'review.restoreBefore': '恢复为本轮之前的内容',
  'review.restoreAfter': '恢复为本轮之后的内容',
  'review.restoreConfirmTitle': '恢复此文件？',
  'review.restoreConfirmDescBefore': '这会用本轮之前的内容覆盖 {name}。此操作在这里无法撤销。',
  'review.restoreConfirmDescAfter': '这会用本轮之后的内容覆盖 {name}。此操作在这里无法撤销。',
  'review.restoreConfirmCancel': '取消',
  'review.restoreConfirmConfirm': '恢复',
  'review.restoreConfirmClose': '关闭',
  'review.restoring': '正在恢复…',
  'review.restored': '已恢复 {name}',
  'review.restoreBinary': '无法恢复二进制文件',
  'review.restoreOversized': '无法恢复：文件过大',
  'review.restoreDiverged': '未恢复 —— {name} 在此对比之后又发生了改动',
  'review.restoreUnavailable': '无法恢复 {name}，请重试',
  'diff.loading': '正在读取改动…',
...
export const en: Record<DeliverablesKey, string> = {
  ...
  'review.restoreAria': 'Restore {name}',
  'review.restoreBefore': 'Restore to before this turn',
  'review.restoreAfter': 'Restore to after this turn',
  'review.restoreConfirmTitle': 'Restore this file?',
  'review.restoreConfirmDescBefore': 'This overwrites {name} with its content from before this turn. This cannot be undone from here.',
  'review.restoreConfirmDescAfter': 'This overwrites {name} with its content from after this turn. This cannot be undone from here.',
  'review.restoreConfirmCancel': 'Cancel',
  'review.restoreConfirmConfirm': 'Restore',
  'review.restoreConfirmClose': 'Close',
  'review.restoring': 'Restoring…',
  'review.restored': 'Restored {name}',
  'review.restoreBinary': 'Cannot restore a binary file',
  'review.restoreOversized': 'Cannot restore; the file is too large',
  'review.restoreDiverged': 'Not restored — {name} changed again since this comparison',
  'review.restoreUnavailable': 'Could not restore {name}. Try again.',
