...
interface ProviderEditorRenderProps extends Pick<
  ProviderEditorProps,
  'namespace' | 'schema' | 'operations' | 't' | 'readOnly' | 'onClose' | 'hideTitle' | 'onBusyChange'
> {
  target: EditorTarget
          ...
          <span className={styles['rowActions']}>
            <button
              ...
              onClick={() => {
                ...
                // One card at a time: the add card closes with whatever it
                // held, since closing either card would otherwise discard
                // the other's draft.
                setAddOpen(false)
