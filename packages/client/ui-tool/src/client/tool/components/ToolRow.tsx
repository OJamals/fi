import { memo, useCallback, useEffect, useMemo, useRef, type KeyboardEvent, type MouseEvent, type ReactNode } from 'react'
...
export const ToolRow = memo(function ToolRow({
  ...
  const { expanded, setExpanded, toggle } = useDisclosure()
  // Starts false so a row first mounted with its deliverable already present also reveals it.
  const previousDefaultExpanded = useRef(false)
