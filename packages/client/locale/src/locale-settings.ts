...
/**
 * Locale identifiers shipped by the browser client, in display order.
 * English leads: it is the product's primary language and the fallback
 * terminus, so the Language row lists it first.
 */
