...
export const zh = {
  ...
  'worktree.manage': '隔离工作树',
  'worktree.loading': '正在加载…',
  'worktree.explain': '从已提交的 HEAD 新建一个分支。源工作区中未提交的更改不会被复制。',
  'worktree.create': '新建隔离工作树',
  'worktree.source': '源：{source}',
  'worktree.branch': '分支：{branch}',
  'worktree.remove': '移除工作树',
  'worktree.confirmRemove': '移除将删除该工作树目录及其工作区登记；分支与会话记录会保留，但此目录中的会话将无法继续。仅当工作树无未提交更改且已合并回源仓库时才能移除。',
  'worktree.confirm': '确认移除',
  'worktree.busy': '处理中…',
  'menu.fork': '分叉会话',
...
export const en = {
  ...
  'worktree.manage': 'Isolated worktree',
  'worktree.loading': 'Loading…',
  'worktree.explain': 'Create a new branch from committed HEAD. Uncommitted changes in the source workspace are not copied.',
  'worktree.create': 'Create isolated worktree',
  'worktree.source': 'Source: {source}',
  'worktree.branch': 'Branch: {branch}',
  'worktree.remove': 'Remove worktree',
  'worktree.confirmRemove': 'Removing deletes the worktree directory and its workspace registration. The branch and session logs remain, but sessions in this directory cannot continue. This only succeeds while the worktree has no uncommitted changes and has been merged back into its source.',
  'worktree.confirm': 'Confirm removal',
  'worktree.busy': 'Working…',
