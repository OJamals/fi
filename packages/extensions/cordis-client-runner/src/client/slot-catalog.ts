...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings-models/src/client/slot-contract.ts:46',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models ModelSetupDialog id \'model-setup\'',
    ],
    replaceRisk: 'none',
