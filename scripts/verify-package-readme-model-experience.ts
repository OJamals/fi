...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  // fi delta: the subscription sign-in layer. All four are configuration-plane
  // only — a composition patch, a configuration-surface Remote owner, a browser
  // settings card, and a host OAuth-flow adapter that mounts no model adapter —
  // so none of them reaches a model request.
