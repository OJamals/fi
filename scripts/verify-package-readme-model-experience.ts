...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  // fi delta: the subscription sign-in layer's configuration-plane packages —
  ...
  'packages/extensions/plugin-compat': { kind: 'indirect', reason: 'The registry mounts existing skill, MCP-client, and hook-bridge plugins per explicit selection; dsh-skill, dsh-mcp-client, dsh-hooks-claude-code, and dsh-hooks-codex own all model-visible rendering.' },
